...
function DoctorChangeTreatmentTable() {
                    ...
                    actions={[
                        {
                            ...
                            onClick: (event, rowData) => {
                                navigate(`/doctordashboard/advancediagnose/changetreatment/${rowData.patient_id}`);
...
export default DoctorChangeTreatmentTable;
