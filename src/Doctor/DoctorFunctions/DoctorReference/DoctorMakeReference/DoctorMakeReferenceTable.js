...
function DoctorMakeReferenceTable() {
    ...
    const fetchPatients = async () => {
        try {
            const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/patients/doctor_make_raferral_table`);
                    ...
                    actions={[
                        {
                            ...
                            onClick: (event, rowData) => {
                                navigate(`/doctordashboard/referral/makereferral/${rowData.patient_id}`);
