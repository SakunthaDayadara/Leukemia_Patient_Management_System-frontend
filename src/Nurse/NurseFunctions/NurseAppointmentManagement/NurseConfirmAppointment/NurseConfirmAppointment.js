...
function NurseConfirmAppointment() {
    ...
    const handleConfirm = async () => {
        try {
            ...
            const responseConfirm = await fetch(`http://${process.env.REACT_APP_BACKEND_URL}/appointments/nurse_confirm_appointment`, {
                method: 'PATCH',
                headers: {
            ...
            const responseMakeAppointment = await fetch(`http://${process.env.REACT_APP_BACKEND_URL}/patients/make_appointment`, {
                method: 'PATCH',
                headers: {
                    'Content-Type': 'application/json'
                },
