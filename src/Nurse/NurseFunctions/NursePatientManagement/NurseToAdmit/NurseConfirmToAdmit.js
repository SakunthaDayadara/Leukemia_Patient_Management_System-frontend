...
function NurseConfirmToAdmit() {
    ...
    useEffect(() => {
        fetch(`${process.env.REACT_APP_BACKEND_URL}/patients/find_by_patient_id?patient_id=${patient_id}`, {
            headers: {
            ...
            .then(data => {
                setPatientData(data);
                return fetch(`${process.env.REACT_APP_BACKEND_URL}/wards/get_wards_by_gender?patient_gender=${data.gender}`, {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('token')}`
                    }
                });
    ...
    const handleWardChange = (event) => {
        ...
        fetch(`${process.env.REACT_APP_BACKEND_URL}/beds/get_available_beds_by_ward?ward_num=${wardNum}`, {
            headers: {
                Authorization: `Bearer ${localStorage.getItem('token')}`
            }
        })
    ...
    const handleConfirm = async () => {
        try {
            ...
            await fetch(`${process.env.REACT_APP_BACKEND_URL}/patients/nurse_admit_patient`, {
                method: 'PATCH',
                headers: {
            ...
            await fetch(`${process.env.REACT_APP_BACKEND_URL}/beds/admit_patient`, {
                method: 'PATCH',
                headers: {
                    'Content-Type': 'application/json',
                    Authorization: `Bearer ${localStorage.getItem('token')}`
            ...
            await fetch(`${process.env.REACT_APP_BACKEND_URL}/appointments/make_appointment_done`, {
                method: 'PATCH',
                headers: {
                    'Content-Type': 'application/json',
                    Authorization: `Bearer ${localStorage.getItem('token')}`
